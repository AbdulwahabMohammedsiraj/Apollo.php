  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    curl_setopt_array($curl, array(
      ...
      CURLOPT_POSTFIELDS => '{
        ...
        "tx_ref": "' . $tx_ref . '",
        "callback_url": "http://localhost/apollo/app/view_profile.php?Profile_ID=' . $profileId . '",
        "return_url": "http://localhost/apollo/app/view_profile.php?Profile_ID=' . $profileId . '",
